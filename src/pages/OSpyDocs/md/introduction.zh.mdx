...
```bash domestic
<script src="https://static.huolala.cn/libs/o-spy/2.1.9/index.min.js" crossorigin="anonymous"></script>
...
```bash jsDelivr
<script src="https://cdn.jsdelivr.net/npm/@huolala-tech/page-spy-plugin-ospy" crossorigin="anonymous"></script>
...
```bash unpkg
<script src="https://unpkg.com/@huolala-tech/page-spy-plugin-ospy" crossorigin="anonymous"></script>
