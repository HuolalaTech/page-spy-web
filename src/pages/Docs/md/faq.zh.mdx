...
import moduleImg from '@/assets/image/screenshot/module.webp';
...
- 修改配置
  ...
  ```json
  {
    ...
    "corsConfig": {
      ...
      "allowHeaders": ["Origin", "Authorization", "Content-Length", "X-Request-Id", "Content-Type", "Referer", "User-Agent", "Host"],
      "allowMethods": ["HEAD", "POST", "GET", "OPTIONS", "PUT", "DELETE", "UPDATE"],
