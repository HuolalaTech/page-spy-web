...
<div style={{ textAlign: 'right', marginBottom: 24 }}>
  <strong>-- Accurately troubleshoot to avoid looking a needle in the ocean</strong>
</div>
...
Once the deployment is successful, you can view how to configure and integrate it in the business project
from the `Inject SDK` menu at the top.
