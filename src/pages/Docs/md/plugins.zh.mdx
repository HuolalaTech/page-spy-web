...
<HeaderLink slug="definition" children="类型定义" level={4} />
...
<HeaderLink slug="convention" children="行为约定" level={4} />
...
<HeaderLink slug="demo" children="插件实现案例" level={4} />

参考 <a href={import.meta.env.VITE_PLUGIN_DATA_HARBOR}>DataHarborPlugin</a> 和 <a href={import.meta.env.VITE_PLUGIN_RRWEB}>RRWebPlugin</a>。

<HeaderLink slug="usage" children="插件的使用方式" level={4} />

<CodeBlock code={`<!-- 引入 SDK -->
