...
- 🐛 修复实时连接记录：WebSocket 关闭后保留已接收消息，EventSource 不再展示响应占位符。查看详情：https://github.com/HuolalaTech/page-spy-web/pull/414;

## v2.4.9

- 🐛 修复异常错误堆栈解析时报错的问题，查看详情：https://github.com/HuolalaTech/page-spy-web/pull/411;

## v2.4.8

- 🆕 新增 `@huolala-tech/page-spy-lynx` SDK 用于调试 [Lynx](https://lynxjs.org/) 应用。查看详情：https://github.com/HuolalaTech/page-spy/pull/150;
- 🆕 SDK 性能优化并修复一些问题，查看详情：https://github.com/HuolalaTech/page-spy/pull/151;


## v2.4.7

- 🐛 修复 SDK 处理动态导入的模块时报错的问题，查看详情：https://github.com/HuolalaTech/page-spy-web/issues/406;

## v2.4.6

- 🆕 更新 `rrweb` 相关依赖到 `2.0.0-alpha.20` 版本;
- 🐛 修复一些问题;

## v2.4.5

- 🆕 修复取消的网络请求的响应数据在详情面板中显示为 `"undefined"` 的问题，查看详情：https://github.com/HuolalaTech/page-spy-web/issues/390;

## v2.4.4

- 🆕 调整网络面板的交互；
- 🐛 修复网络面板出现重复数据的问题，以及修复 `fetch` 的请求时长；

## v2.4.3

- 🐛 修复浏览器 SDK 逻辑，使 `socketStore.connectable` 状态与 `offline` 初始化选项关联;


## v2.4.2

- 🐛 修复浏览器 SDK 在页面切换到前台时自动重连的问题，查看详情：https://github.com/HuolalaTech/page-spy/pull/146;

## v2.4.1

- 🐛 修复 SDK 的 WebSocket 插件无法正常工作的问题;
- 🐛 修复调试端处理 WebSocket / EventSource 请求响应数据时异常的问题;

## v2.4.0

- 🆕 浏览器和 ReactNative 支持查看 WebSocket 请求，查看详情：https://github.com/HuolalaTech/page-spy/pull/143;
- 🐛 修复发布 NPM 包工作流里依赖包版本不正确的问题;

## v2.3.3

- 🐛 修复 v2.3.2 镜像缺失 libc.so 的问题;

## v2.3.2

- 🆕 支持配置 mysql 用于持久化离线日志数据，查看详情：https://github.com/HuolalaTech/page-spy-api/issues/15;
- 🆕 支持多容器部署时使用 dns name 代替 IP 地址，查看详情：https://github.com/HuolalaTech/page-spy-api/issues/16;
- 🐛 修复一些问题;
...
- 🐛 浏览器 SDK 修复了资源收集器在低版本浏览器中无法正常工作的问题，查看详情：https://github.com/HuolalaTech/page-spy/pull/140;
