...
- 🐛 실시간 연결 기록을 수정했습니다. WebSocket 종료 후에도 수신한 메시지를 유지하고 EventSource 응답 플레이스홀더를 숨깁니다. 자세한 내용은 https://github.com/HuolalaTech/page-spy-web/pull/414 참조하세요;

## v2.4.9

- 🐛 오류 스택 파서가 무효한 오류 스택을 구문 분석할 때 오류가 발생하는 문제를 수정했습니다. 자세한 내용은 https://github.com/HuolalaTech/page-spy-web/pull/411 참조하세요;

## v2.4.8

- 🆕 `@huolala-tech/page-spy-lynx` SDK를 추가했습니다. 자세한 내용은 https://github.com/HuolalaTech/page-spy/pull/150 참조하세요;
- 🆕 SDK 성능을 최적화하고 몇 가지 문제를 수정했습니다. 자세한 내용은 https://github.com/HuolalaTech/page-spy/pull/151 참조하세요;

## v2.4.7

- 🐛 SDK가 동적으로 가져온 모듈을 처리할 때 발생하는 문제를 수정했습니다. 자세한 내용은 https://github.com/HuolalaTech/page-spy-web/issues/406 참조하세요;

## v2.4.6

- 🆕 `rrweb` 관련 종속성을 `2.0.0-alpha.20` 버전으로 업데이트했습니다;
- 🐛 몇 가지 문제를 수정했습니다;

## v2.4.5

- 🆕 취소된 네트워크 요청의 응답 데이터가 상세 패널에 `"undefined"`로 표시되는 문제를 수정했습니다. 자세한 내용은 https://github.com/HuolalaTech/page-spy-web/issues/390 참조하세요;

## v2.4.4

- 🆕 네트워크 패널의 인터랙션을 조정했습니다.  
- 🐛 네트워크 패널에서 중복 데이터가 표시되는 문제와 `fetch` 요청 시간 계산 문제를 수정했습니다. 

## v2.4.3

- 🐛 브라우저 SDK 로직을 수정하여 `socketStore.connectable` 상태를 `offline` 초기화 옵션에 연결했습니다;

## v2.4.2

- 🐛 브라우저 SDK가 페이지가 프론트그라운드로 전환될 때 자동으로 다시 연결되는 문제를 수정했습니다. 자세한 내용은 https://github.com/HuolalaTech/page-spy/pull/146 참조하세요;

## v2.4.1

- 🐛 SDK의 WebSocket 플러그인이 정상적으로 작동하지 않는 문제를 수정했습니다;
- 🐛 디버거가 WebSocket / EventSource 요청 응답 데이터를 처리할 때 문제를 수정했습니다;
