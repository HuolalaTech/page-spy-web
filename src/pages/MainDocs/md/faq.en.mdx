...
PageSpy collects logs including but not limited to user operations, interface changes, console, and network requests, etc. For large logs, we provide solutions from different dimensions.
