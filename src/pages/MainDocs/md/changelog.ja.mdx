...
- 🐛 リアルタイム接続の記録を修正しました。WebSocket を閉じた後も受信済みメッセージを保持し、EventSource のレスポンスプレースホルダーを非表示にします。詳細はこちら：https://github.com/HuolalaTech/page-spy-web/pull/414;

## v2.4.9

- 🐛 エラースタック解析時に無効なエラースタックが原因でエラーが発生する問題を修正しました。詳細はこちら：https://github.com/HuolalaTech/page-spy-web/pull/411;

## v2.4.8

- 🆕 `@huolala-tech/page-spy-lynx` SDK を追加しました。詳細はこちら：https://github.com/HuolalaTech/page-spy/pull/150;
- 🆕 SDK のパフォーマンスを最適化し、いくつかの問題を修正しました。詳細はこちら：https://github.com/HuolalaTech/page-spy/pull/151;

## v2.4.7

- 🐛 SDK が動的にインポートされたモジュールを処理する際の問題を修正しました。詳細はこちら：https://github.com/HuolalaTech/page-spy-web/issues/406;

## v2.4.6

- 🆕 `rrweb` 関連の依存関係を `2.0.0-alpha.20` バージョンに更新しました;
- 🐛 いくつかの問題を修正しました;

## v2.4.5

- 🆕 キャンセルされたネットワークリクエストの応答データが詳細パネルで `"undefined"` と表示される問題を修正しました。詳細はこちら：https://github.com/HuolalaTech/page-spy-web/issues/390;

## v2.4.4

- 🆕 ネットワークパネルのインタラクションを調整しました。  
- 🐛 ネットワークパネルで重複データが表示される問題を修正し、`fetch` のリクエスト時間を修正しました。

## v2.4.3

- 🐛 ブラウザ SDK のロジックを修正し、`socketStore.connectable` 状態を `offline` 初期化オプションに関連付けました;

## v2.4.2

- 🐛 ブラウザ SDK がページがフロントグラウンドに切り替わったときに自動的に再接続する問題を修正しました。詳細はこちら：https://github.com/HuolalaTech/page-spy/pull/146;

## v2.4.1

- 🐛 SDK の WebSocket プラグインが正常に動作しない問題を修正しました;
- 🐛 デバッガーが WebSocket / EventSource リクエスト応答データを処理する際の問題を修正しました;
