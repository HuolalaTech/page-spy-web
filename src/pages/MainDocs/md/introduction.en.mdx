...
- **Debugging Client**: The debugging client is the part that developers use, providing various debugging features such as online debugging and offline playback.
- **SDK**: The SDK is responsible for collecting data from the user's project and sending it to the debugging client.
- **Server**: The server is responsible for relaying messages between the debugging client and the SDK, as well as storing data.
...
### Debugging Client Overview#page-overview

#### Online Debugging Mode#online-debugging
...
#### Offline Debugging Mode#offline-debugging
