!(function (e, n) {
  'object' == typeof exports && 'object' == typeof module
    ? (module.exports = n(require('fs'), require('path')))
    : 'function' == typeof define && define.amd
    ? define(['fs', 'path'], n)
    : 'object' == typeof exports
    ? (exports.sourceMap = n(require('fs'), require('path')))
    : (e.sourceMap = n(e.fs, e.path));
})(window, function (e, n) {
  return (function (e) {
    var n = {};
    function t(r) {
    ...
    function (e, n) {
      ...
      const s = (function (e) {
        ...
        return function (t) {
          for (let e = 0; e < n.length; e++)
            if (n[e].input === t) {
              const t = n[0];
              return (n[0] = n[e]), (n[e] = t), n[0].result;
            }
          const r = e(t);
          return (
            n.unshift({ input: t, result: r }), n.length > 32 && n.pop(), r
          );
        };
      })(function (e) {
        let t = e;
        ...
        const s = n.isAbsolute(t),
          l = [];
        let a = 0,
          u = 0;
        for (;;) {
          if (((a = u), (u = t.indexOf('/', a)), -1 === u)) {
            l.push(t.slice(a));
            break;
          }
          for (l.push(t.slice(a, u)); u < t.length && '/' === t[u]; ) u++;
        }
        let c = 0;
      ...
      function l(e, n) {
        ...
        const t = o(n),
          l = o(e);
        if ((l && (e = l.path || '/'), t && !t.scheme))
          return l && (t.scheme = l.scheme), i(t);
        if (t || n.match(r)) return n;
        if (l && !l.host && !l.path) return (l.host = n), i(l);
        const a = '/' === n.charAt(0) ? n : s(e.replace(/\/+$/, '') + '/' + n);
        return l ? ((l.path = a), i(l)) : a;
      }
      (n.normalize = s),
        (n.join = l),
      ...
      function c(e) {
        ...
        if (
          ...
          return !1;
        for (let t = n - 10; t >= 0; t--) if (36 !== e.charCodeAt(t)) return !1;
        return !0;
      }
      function g(e, n) {
      ...
      (n.toSetString = a
                ...
                : ((r = e.originalColumn - n.originalColumn),
                  0 !== r || t
                    ...
                    : ((r = e.generatedColumn - n.generatedColumn),
                      0 !== r
                        ? r
                        : ((r = e.generatedLine - n.generatedLine),
                          0 !== r ? r : g(e.name, n.name)))));
        }),
        (n.compareByGeneratedPositionsDeflated = function (e, n, t) {
          let r = e.generatedLine - n.generatedLine;
          return 0 !== r
            ? r
            : ((r = e.generatedColumn - n.generatedColumn),
              0 !== r || t
                ? r
                : ((r = g(e.source, n.source)),
                  0 !== r
                    ? r
                    : ((r = e.originalLine - n.originalLine),
                      0 !== r
        ...
        (n.compareByGeneratedPositionsInflated = function (e, n) {
          let t = e.generatedLine - n.generatedLine;
          return 0 !== t
            ? t
            : ((t = e.generatedColumn - n.generatedColumn),
              0 !== t
                ? t
                : ((t = g(e.source, n.source)),
                  0 !== t
                    ? t
        ...
        (n.computeSourceURL = function (e, n, t) {
          if (
            ...
            if (e.path) {
              const n = e.path.lastIndexOf('/');
              n >= 0 && (e.path = e.path.substring(0, n + 1));
            }
            n = l(i(e), n);
          }
          return s(n);
    ...
    function (e, n, t) {
      ...
      class l {
        ...
        static fromSourceMap(e) {
          const n = e.sourceRoot,
            t = new l({ file: e.file, sourceRoot: n });
          return (
            ...
            e.sources.forEach(function (r) {
              let i = r;
              null !== n && (i = o.relative(n, r)),
                t._sources.has(i) || t._sources.add(i);
              const s = e.sourceContentFor(r);
        ...
        addMapping(e) {
          const n = o.getArg(e, 'generated'),
            t = o.getArg(e, 'original', null);
          let r = o.getArg(e, 'source', null),
            i = o.getArg(e, 'name', null);
          this._skipValidation || this._validateMapping(n, t, r, i),
            null != r &&
        ...
        applySourceMap(e, n, t) {
          ...
          const l =
              this._mappings.toArray().length > 0 ? new i() : this._sources,
            a = new i();
          this._mappings.unsortedForEach(function (n) {
            if (n.source === r && null != n.originalLine) {
              ...
              null != r.source &&
                ...
                null != s && (n.source = o.relative(s, n.source)),
                (n.originalLine = r.line),
                (n.originalColumn = r.column),
                null != r.name && (n.name = r.name));
            }
            const i = n.source;
        ...
        _serializeMappings() {
          ...
          for (let m = 0, d = h.length; m < d; m++) {
            if (((n = h[m]), (e = ''), n.generatedLine !== l))
              for (s = 0; n.generatedLine !== l; ) (e += ';'), l++;
            else if (m > 0) {
              if (!o.compareByGeneratedPositionsInflated(n, h[m - 1])) continue;
              e += ',';
            }
            (e += r.encode(n.generatedColumn - s)),
              (s = n.generatedColumn),
              null != n.source &&
        ...
        _generateSourcesContent(e, n) {
          return e.map(function (e) {
            if (!this._sourcesContents) return null;
            null != n && (e = o.relative(n, e));
            const t = o.toSetString(e);
      ...
      (l.prototype._version = 3), (n.SourceMapGenerator = l);
    },
    function (e, n, t) {
      const r = t(6);
      n.encode = function (e) {
        ...
        do {
          (n = 31 & o), (o >>>= 5), o > 0 && (n |= 32), (t += r.encode(n));
        } while (o > 0);
        return t;
      };
    },
    function (e, n) {
      class t {
        ...
        static fromArray(e, n) {
          const r = new t();
          for (let t = 0, o = e.length; t < o; t++) r.add(e[t], n);
          return r;
        }
        size() {
        ...
        add(e, n) {
          ...
          (t && !n) || this._array.push(e), t || this._set.set(e, r);
        }
        has(e) {
          return this._set.has(e);
        }
        indexOf(e) {
          const n = this._set.get(e);
          if (n >= 0) return n;
    ...
    function (e, n, t) {
      (function (n) {
        if (
          function () {
            return 'undefined' != typeof window && this === window;
          }.call()
        ) {
          let n = null;
          (e.exports = function () {
            ...
            (e.exports.initialize = (e) => (n = e));
        } else {
          const r = t(10),
            o = t(11);
          (e.exports = function () {
            return new Promise((e, t) => {
              const i = o.join(n, 'mappings.wasm');
              r.readFile(i, null, (n, r) => {
                n ? t(n) : e(r.buffer);
              });
            });
          }),
    ...
    function (e, n, t) {
      (n.SourceMapGenerator = t(1).SourceMapGenerator),
        (n.SourceMapConsumer = t(8).SourceMapConsumer),
        (n.SourceNode = t(13).SourceNode);
    },
    function (e, n) {
      const t =
        ...
        add(e) {
          !(function (e, n) {
            ...
            return (
              o > t ||
              (o == t && s >= i) ||
              r.compareByGeneratedPositionsInflated(e, n) <= 0
            );
          })(this._last, e)
    ...
    function (e, n, t) {
        ...
        constructor(e, n) {
          return e == a
            ...
            : (function (e, n) {
                ...
                const o = null != t.sections ? new g(t, n) : new c(t, n);
                return Promise.resolve(o);
              })(e, n);
        }
        static initialize(e) {
          s.initialize(e['lib/mappings.wasm']);
        }
        static fromSourceMap(e, n) {
          return (function (e, n) {
            return c.fromSourceMap(e, n);
          })(e, n);
        }
        static async with(e, n, t) {
          const r = await new u(e, n);
          try {
            return await t(r);
          } finally {
            r.destroy();
      ...
      class c extends u {
        constructor(e, n) {
          return super(a).then((t) => {
            let o = e;
            'string' == typeof e && (o = r.parseSourceMapInput(e));
            const s = r.getArg(o, 'version');
            let a = r.getArg(o, 'sources');
            const u = r.getArg(o, 'names', []);
            let c = r.getArg(o, 'sourceRoot', null);
            const g = r.getArg(o, 'sourcesContent', null),
              p = r.getArg(o, 'mappings'),
              h = r.getArg(o, 'file', null);
            if (s != t._version) throw new Error('Unsupported version: ' + s);
            return (
              c && (c = r.normalize(c)),
              (a = a
                .map(String)
              ...
              (t._names = i.fromArray(u.map(String), !0)),
              (t._sources = i.fromArray(a, !0)),
              (t._absoluteSources = t._sources.toArray().map(function (e) {
                return r.computeSourceURL(c, e, n);
              })),
              (t.sourceRoot = c),
              (t.sourcesContent = g),
              (t._mappings = p),
        ...
        _findSourceIndex(e) {
          ...
          for (let n = 0; n < this._absoluteSources.length; ++n)
        ...
        _parseMappings(e, n) {
          const t = e.length,
            r = this._wasm.exports.allocate_mappings(t),
            o = new Uint8Array(this._wasm.exports.memory.buffer, r, t);
          for (let n = 0; n < t; n++) o[n] = e.charCodeAt(n);
          const i = this._wasm.exports.parse_mappings(r);
          if (!i) {
            const e = this._wasm.exports.get_last_error();
            let n = `Error parsing mappings (code ${e}): `;
            switch (e) {
              case 1:
                n +=
        ...
        eachMapping(e, n, t) {
          const o = n || null,
            i = t || u.GENERATED_ORDER,
            s = this.sourceRoot;
          this._wasm.withMappingCallback(
            (n) => {
              null !== n.source &&
                ((n.source = this._sources.at(n.source)),
                (n.source = r.computeSourceURL(
                  s,
                  n.source,
                  this._sourceMapURL,
                )),
                null !== n.name && (n.name = this._names.at(n.name))),
                e.call(o, n);
            },
            () => {
              switch (i) {
        ...
        allGeneratedPositionsFor(e) {
          let n = r.getArg(e, 'source');
          const t = r.getArg(e, 'line'),
            o = e.column || 0;
          if (((n = this._findSourceIndex(n)), n < 0)) return [];
          if (t < 1) throw new Error('Line numbers must be >= 1');
          if (o < 0) throw new Error('Column numbers must be >= 0');
          const i = [];
          return (
            this._wasm.withMappingCallback(
              (e) => {
                let n = e.lastGeneratedColumn;
                this._computedColumnSpans && null === n && (n = 1 / 0),
                  i.push({
        ...
        originalPositionFor(e) {
          ...
          if (n.generatedLine < 1) throw new Error('Line numbers must be >= 1');
          if (n.generatedColumn < 0)
            throw new Error('Column numbers must be >= 0');
          let t,
            o = r.getArg(e, 'bias', u.GREATEST_LOWER_BOUND);
          if (
            (null == o && (o = u.GREATEST_LOWER_BOUND),
            this._wasm.withMappingCallback(
              (e) => (t = e),
              () => {
            ...
            t && t.generatedLine === n.generatedLine)
          ) {
            let e = r.getArg(t, 'source', null);
            null !== e &&
              ((e = this._sources.at(e)),
              (e = r.computeSourceURL(this.sourceRoot, e, this._sourceMapURL)));
            let n = r.getArg(t, 'name', null);
            return (
              null !== n && (n = this._names.at(n)),
              {
                source: e,
        ...
        sourceContentFor(e, n) {
          if (!this.sourcesContent) return null;
          const t = this._findSourceIndex(e);
        ...
        generatedPositionFor(e) {
          ...
          if (t.originalLine < 1) throw new Error('Line numbers must be >= 1');
          if (t.originalColumn < 0)
            throw new Error('Column numbers must be >= 0');
          let o,
            i = r.getArg(e, 'bias', u.GREATEST_LOWER_BOUND);
          if (
            (null == i && (i = u.GREATEST_LOWER_BOUND),
            this._wasm.withMappingCallback(
              (e) => (o = e),
              () => {
      ...
      (c.prototype.consumer = u), (n.BasicSourceMapConsumer = c);
      class g extends u {
        constructor(e, n) {
          return super(a).then((t) => {
            let o = e;
            ...
            return Promise.all(
              l.map((e) => {
                ...
                a = t;
                return new u(r.getArg(e, 'map'), n).then((e) => ({
                  generatedOffset: {
                    generatedLine: o + 1,
                    generatedColumn: i + 1,
                  },
        ...
        get sources() {
          ...
          for (let n = 0; n < this._sections.length; n++)
            for (let t = 0; t < this._sections[n].consumer.sources.length; t++)
        ...
        originalPositionFor(e) {
          const n = {
            ...
            t = o.search(n, this._sections, function (e, n) {
              const t = e.generatedLine - n.generatedOffset.generatedLine;
          ...
          return i
            ? i.consumer.originalPositionFor({
                ...
                column:
                  n.generatedColumn -
                  (i.generatedOffset.generatedLine === n.generatedLine
        ...
        sourceContentFor(e, n) {
          for (let n = 0; n < this._sections.length; n++) {
            const t = this._sections[n].consumer.sourceContentFor(e, !0);
            if (t) return t;
          }
          if (n) return null;
        ...
        generatedPositionFor(e) {
          for (let n = 0; n < this._sections.length; n++) {
            ...
            if (-1 === t.consumer._findSourceIndex(r.getArg(e, 'source')))
              continue;
            const o = t.consumer.generatedPositionFor(e);
            if (o) {
              return {
        ...
        _parseMappings(e, n) {
          const t = (this.__generatedMappingsUnsorted = []),
            o = (this.__originalMappingsUnsorted = []);
          for (let e = 0; e < this._sections.length; e++) {
            const n = this._sections[e],
              i = [];
            n.consumer.eachMapping((e) => i.push(e));
            for (let e = 0; e < i.length; e++) {
              const s = i[e];
              let l = r.computeSourceURL(
                n.consumer.sourceRoot,
                null,
                this._sourceMapURL,
              );
              this._sources.add(l), (l = this._sources.indexOf(l));
              let a = null;
              s.name &&
                (this._names.add(s.name), (a = this._names.indexOf(s.name)));
              const u = {
                source: l,
                generatedLine:
                  s.generatedLine + (n.generatedOffset.generatedLine - 1),
                generatedColumn:
                  s.generatedColumn +
                  (n.generatedOffset.generatedLine === s.generatedLine
              ...
              t.push(u), 'number' == typeof u.originalLine && o.push(u);
            }
          }
        }
        eachMapping(e, n, t) {
          ...
          const s = this.sourceRoot;
          i.map(function (e) {
            let n = null;
            return (
              null !== e.source &&
                ((n = this._sources.at(e.source)),
                (n = r.computeSourceURL(s, n, this._sourceMapURL))),
              {
                source: n,
        ...
        allGeneratedPositionsFor(e) {
          ...
          if (s >= 0) {
            let t = this._originalMappings[s];
            if (void 0 === e.column) {
              const e = t.originalLine;
              for (; t && t.originalLine === e; ) {
                let e = t.lastGeneratedColumn;
                this._computedColumnSpans && null === e && (e = 1 / 0),
                  i.push({
                    line: r.getArg(t, 'generatedLine', null),
                    column: r.getArg(t, 'generatedColumn', null),
                    lastColumn: e,
                  }),
                  (t = this._originalMappings[++s]);
              }
            } else {
              const e = t.originalColumn;
              for (; t && t.originalLine === n && t.originalColumn == e; ) {
                let e = t.lastGeneratedColumn;
                this._computedColumnSpans && null === e && (e = 1 / 0),
                  i.push({
                    line: r.getArg(t, 'generatedLine', null),
      ...
      n.IndexedSourceMapConsumer = g;
    },
    function (e, n) {
      (n.GREATEST_LOWER_BOUND = 1),
        (n.LEAST_UPPER_BOUND = 2),
        (n.search = function (e, t, r, o) {
          if (0 === t.length) return -1;
          let i = (function e(t, r, o, i, s, l) {
            const a = Math.floor((r - t) / 2) + t,
              u = s(o, i[a], !0);
            return 0 === u
              ? a
              : u > 0
          ...
          (i = r()
            .then((n) =>
              WebAssembly.instantiate(n, {
                env: {
                  mapping_callback(n, t, r, i, s, l, a, u, c, g) {
                    const p = new o();
                    (p.generatedLine = n + 1),
                      (p.generatedColumn = t),
                      r && (p.lastGeneratedColumn = i - 1),
                      s &&
                        ((p.source = l),
                        (p.originalLine = a + 1),
                        (p.originalColumn = u),
    ...
    function (e, n, t) {
      const r = t(1).SourceMapGenerator,
        o = t(0),
        i = /(\r?\n)/,
        s = '$$$isSourceNode$$$';
      class l {
        ...
        static fromStringWithSourceMap(e, n, t) {
          const r = new l(),
            s = e.split(i);
          let a = 0;
          const u = function () {
            ...
            n.eachMapping(function (e) {
              if (null !== h) {
                if (!(g < e.generatedLine)) {
                  c = s[a] || '';
                  const n = c.substr(0, e.generatedColumn - p);
                  return (
                    (s[a] = c.substr(e.generatedColumn - p)),
                    (p = e.generatedColumn),
                    m(h, n),
                    void (h = e)
                  );
              ...
              for (; g < e.generatedLine; ) r.add(u()), g++;
              p < e.generatedColumn &&
                ((c = s[a] || ''),
                r.add(c.substr(0, e.generatedColumn)),
                (s[a] = c.substr(e.generatedColumn)),
                (p = e.generatedColumn)),
                (h = e);
            }, this),
            a < s.length && (h && m(h, u()), r.add(s.splice(a).join(''))),
            n.sources.forEach(function (e) {
              const i = n.sourceContentFor(e);
              null != i &&
                (null != t && (e = o.join(t, e)), r.setSourceContent(e, i));
            }),
            r
          );
          function m(e, n) {
            if (null === e || void 0 === e.source) r.add(n);
              ...
              const i = t ? o.join(t, e.source) : e.source;
              r.add(new l(e.originalLine, e.originalColumn, i, n, e.name));
            }
          }
        }
        add(e) {
        ...
        prepend(e) {
          if (Array.isArray(e))
            for (let n = e.length - 1; n >= 0; n--) this.prepend(e[n]);
          else {
            if (!e[s] && 'string' != typeof e)
              throw new TypeError(
                'Expected a SourceNode, string, or an array of SourceNodes and strings. Got ' +
        ...
        walkSourceContents(e) {
          for (let n = 0, t = this.children.length; n < t; n++)
            this.children[n][s] && this.children[n].walkSourceContents(e);
          const n = Object.keys(this.sourceContents);
