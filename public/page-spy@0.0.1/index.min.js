var PageSpy = (function () {
  ...
  var k = new ((function () {
      function i() {
        s(this, i), u(this, 'store', {}), u(this, 'instanceStore', {});
      }
      return (
        l(
          i,
    ...
    O = new ((function () {
      function e() {
        s(this, e),
          u(this, 'socket', null),
          u(this, 'socketUrl', ''),
          u(this, 'socketConnection', null),
          u(this, 'timer', null),
          u(this, 'reconnectTimes', 3),
          u(this, 'messages', []),
          u(this, 'reconnectable', !0),
          u(this, 'connectionStatus', !1),
          u(this, 'events', {
            refresh: [],
            debug: [],
            'atom-detail': [],
          ...
          [
                ...
                try {
                  ...
                  (this.socket = new WebSocket(e)),
                    ...
                    this.socket.addEventListener('error', function () {
                      (t.reconnectable = !1), t.connectOffline();
                    });
                } catch (e) {
            ...
            },
            {
              ...
              value: function () {
                (this.socket = null),
                  ...
                  this.reconnectable
                    ? this.tryReconnect()
                    : sessionStorage.setItem(x, JSON.stringify({ usable: !1 }));
              },
            },
            {
              key: 'tryReconnect',
            ...
            },
            {
              ...
              value: function (e, t) {
                e = {
                  type: 'send',
                  content: { data: e, from: this.socketConnection, to: t },
                };
                this.send(e);
              },
            },
            ...
            },
            {
              ...
              value: function () {
                var e;
                this.clearPing(), null != (e = this.socket) && e.close();
              },
            },
          ],
          [
            ...
            },
            {
              ...
              value: function (e, t) {
                var e = e.source,
                  ...
                  e = e.data;
                'atom-detail' === n &&
                  ((n = k.get(e) || {}), t(E('atom-detail-'.concat(e), n, !1)));
              },
            },
            {
              ...
              value: function (e, t) {
                ...
                'atom-getter' === a &&
                  ...
                  t(E('atom-getter-'.concat(a), k.transformToAtom(o))));
              },
            },
          ],
        ),
  ...
  var oe = (function () {
      function e() {
        s(this, e), u(this, 'name', 'ConsolePlugin'), u(this, 'console', {});
      }
      return (
        l(e, [
          {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              e.logs &&
                e.logs.length &&
                ((t = this.console)[e.logType].apply(t, G(e.logs)),
                (e.logs = e.logs.map(function (e) {
                  return k.transformToAtom(e);
                })),
                (t = E(
                  w,
                  (function (t) {
    ...
    ae = (function () {
      function o() {
        s(this, o), u(this, 'name', 'ErrorPlugin'), u(this, 'error', null);
      }
      return (
        l(
          o,
          ...
          [
            {
              ...
              value: function (e) {
                e = E(w, {
                  logType: 'error',
                  logs: [k.transformToAtom(e)],
                  time: Date.now(),
                  url: window.location.href,
                });
                O.broadcastMessage(e);
              },
            },
          ],
        ),
    ...
    P = l(function e(t) {
      s(this, e),
        ...
        u(this, 'method', ''),
        u(this, 'url', ''),
        u(this, 'requestType', 'xhr'),
        u(this, 'requestHeader', null),
        u(this, 'status', 0),
        u(this, 'statusText', ''),
        u(this, 'readyState', 0),
        u(this, 'responseReason', null),
        u(this, 'responseType', ''),
        u(this, 'responseHeader', null),
        u(this, 'startTime', 0),
        u(this, 'endTime', 0),
        u(this, 'costTime', 0),
        u(this, 'getData', null),
        u(this, 'postData', null),
        u(this, 'withCredentials', !1),
        (this.id = t);
    });
  function ie(t, e) {
    var n,
  ...
  var se = 'Exceed maximum limit',
    ce = (function () {
      function d() {
        s(this, d),
          u(this, 'name', 'NetworkPlugin'),
          u(this, 'xhrOpen', null),
          u(this, 'xhrSend', null),
          u(this, 'xhrSetRequestHeader', null),
          u(this, 'fetch', null),
          u(this, 'sendBeacon', null),
          u(this, 'reqList', {});
      }
      return (
        l(
                ...
                window.XMLHttpRequest &&
                  ...
                  (window.XMLHttpRequest.prototype.open = function () {
                    for (
                      ...
                      t[n] = arguments[n];
                    function r() {
                      p.reqList[c] || (p.reqList[c] = new P(c));
                      var n = p.reqList[c];
                    ...
                    var t,
                      ...
                      r =
                        1 < arguments.length && void 0 !== arguments[1]
                          ...
                          : {},
                      o = f(),
                      a = ((l.reqList[o] = new P(o)), l.reqList[o]),
                      i = 'GET',
                      s = A(e)
                        ? ((i = r.method || 'GET'),
                          (t = T(e)),
                          (null == r ? void 0 : r.headers) || null)
                        : ((i = e.method || 'GET'), (t = T(e.url)), e.headers),
                      c = t.href.split('?') || [],
                      c =
                        ((a.name = c.shift() || ''),
                        (a.name =
      ...
      (function (Q, p, u, f) {
        ...
        var z,
          ...
          t =
            ...
            'Moz O ms Webkit'),
          H = e._config.usePrefixes ? t.split(' ') : [],
          w =
            ((e._cssomPrefixes = H),
            (e.atRule = F),
        ...
        o))
          if (o.hasOwnProperty(pe)) {
            ...
            for (
              L = h(C.fn, 'function') ? C.fn() : C.fn, M = 0;
              M < B.length;
              M++
            )
              1 === (R = B[M].split('.')).length
                ? (g[R[0]] = L)
                : ((g[R[0]] && (!g[R[0]] || g[R[0]] instanceof Boolean)) ||
                    (g[R[0]] = new Boolean(g[R[0]])),
                  (g[R[0]][R[1]] = L)),
                G.push((L ? '' : 'no-') + R.join('-'));
          }
        I(G), delete e.addTest, delete e.addAsyncTest;
  ...
  var ge = (function () {
      function e() {
        s(this, e), (this.name = 'SystemPlugin');
      }
      var t;
      return (
        l(e, [
    ...
    ve = (function () {
      function n() {
        s(this, n), u(this, 'name', 'PagePlugin');
      }
      return (
        l(
          n,
          [
            {
              ...
              value: function () {
                window.addEventListener('load', function () {
                  ...
                  O.addListener('refresh', function (e, t) {
          ...
          [
            {
              key: 'collectHtml',
              value: function () {
                return E('page', { html: document.documentElement.outerHTML });
              },
            },
          ],
        ),
  ...
  var Ee = (function () {
      function i() {
        s(this, i), u(this, 'name', 'StoragePlugin');
      }
      return (
        l(
          i,
    ...
    ke = (function () {
      function t() {
        ...
        if ((s(this, t), u(this, 'protocol', []), !(this.base = e)))
          throw Error('The api base url cannot be empty');
        this.protocol = window.location.protocol.startsWith('https')
          ? ['https://', 'wss://']
          : ['http://', 'ws://'];
      }
      return (
  ...
  var L = null == (D = document.currentScript) ? void 0 : D.src,
    Te = function () {
      return {
        api: L ? new URL(L).host : '',
        clientOrigin: L ? new URL(L).origin : '',
      };
    },
    je = '__pageSpy';
  return (function () {
    function r() {
      var t = this,
        ...
        e =
          ...
          u(this, 'version', Se),
          u(this, 'plugins', {}),
          u(this, 'config', { api: '', clientOrigin: '' }),
          u(this, 'name', ''),
          u(this, 'address', ''),
          u(this, 'roomUrl', ''),
          u(this, 'project', 'default'),
          u(this, 'clientOrigin', ''),
          u(this, 'socketStore', O),
          (this.config = ((e = e), Pe(Pe({}, Te()), e))),
          this.config),
        n = e.api,
        e = e.clientOrigin;
      (this.request = new ke(n)),
        (this.clientOrigin = e),
    ...
    return (
      l(r, [
                ...
                return d.wrap(
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          if (null === (t = sessionStorage.getItem(x)))
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (e.next = 2), this.request.createRoom(this.project)
                          );
                        case 2:
                          (t = e.sent),
                            (t = t.data),
        ...
        },
        {
          ...
          value: function () {
            this.refreshRoomInfo(), O.init(this.roomUrl);
          },
        },
        {
          key: 'deferRender',
        ...
        },
        {
          ...
          value: function () {
            var n,
              ...
              a,
              e = document.createElement('div'),
              t = ((e.id = je), (this.root = e), document.createElement('div')),
              i =
