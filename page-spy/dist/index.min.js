var PageSpy = (function () {
            ...
            (t.dataset.testid = 'copy-button'),
              ...
              (t.onclick = function (e) {
                ...
                e = ''
                  ...
                  .concat(r, '&address=')
                  .concat(o);
                z(e) && (alert('Copy successfully!'), n) && n();
              }),
              this.el.append(e, t);
          },
        },
  ...
  var k = new ((function () {
      function i() {
        s(this, i), l(this, 'store', {}), l(this, 'instanceStore', {});
      }
      return (
        c(
          i,
                ...
                return t
                  ? ((n = {}),
                    ...
                    Object.keys(r).forEach(function (e) {
                      var t = r[e];
                      p(t, 'value') && (t.value = o.transformToAtom(t.value)),
          ...
          [
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                (n = this.socketConnection),
                  this.send({ type: b, content: { data: e, from: n, to: t } });
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                a || -1 < [b, 'ping'].indexOf(e.type) || this.messages.push(e);
              },
            },
            {
              key: 'close',
  ...
  var ae = (function () {
      function e() {
        s(this, e), l(this, 'name', 'ConsolePlugin'), l(this, 'console', {});
      }
      return (
        c(e, [
          {
    ...
    ie = (function () {
      function o() {
        s(this, o), l(this, 'name', 'ErrorPlugin'), l(this, 'error', null);
      }
      return (
        c(
          o,
  ...
  var ye,
    ...
    fe = 'https://github.com/Modernizr/Modernizr/tree/master/feature-detects',
    me = ['indexeddb', 'apng', 'avif', 'exiforientation', 'jpeg2000', 'webp'];
  function Ae() {
    return (Ae = a(
      u.mark(function e() {
        var n, t;
  ...
  var ve = (function () {
    ...
    be = (function () {
      function n() {
        s(this, n), l(this, 'name', 'PagePlugin');
      }
      return (
        c(
          n,
  ...
  var ke = (function () {
      function i() {
        s(this, i), l(this, 'name', 'StoragePlugin');
      }
      return (
        c(
          i,
    ...
    Se = (function () {
      function t() {
        ...
        if ((s(this, t), l(this, 'protocol', []), !(this.base = e)))
  ...
  var R = null == (D = document.currentScript) ? void 0 : D.src,
    je = function () {
      return {
        api: R ? new URL(R).host : '',
        clientOrigin: R ? new URL(R).origin : '',
      };
    },
    Be = '__pageSpy';
  return (function () {
    function r() {
      var t = this,
        ...
        e =
          ...
          l(this, 'version', xe),
          l(this, 'plugins', {}),
          l(this, 'config', { api: '', clientOrigin: '' }),
          l(this, 'name', ''),
          l(this, 'address', ''),
          l(this, 'roomUrl', ''),
          l(this, 'project', 'default'),
          l(this, 'clientOrigin', ''),
          l(this, 'socketStore', O),
          (this.config = ((e = e), Te(Te({}, je()), e))),
          this.config),
        n = e.api,
        e = e.clientOrigin;
      (this.request = new Se(n)),
        (this.clientOrigin = e),
        ...
        },
        {
          ...
          value: function () {
            var n,
              ...
              a,
              e = document.createElement('div'),
              t = ((e.id = Be), (this.root = e), document.createElement('div')),
              i =
